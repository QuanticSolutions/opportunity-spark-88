...
import { updateProfile, type AppRole } from "@/services/profile";
...
export default function SignUpAccount() {
  ...
  const role = (location.state as { role?: AppRole })?.role;
      ...
      >
        ...
        <Card className="glass-card border-border/50">
          <CardHeader className="text-center">
            ...
            <CardDescription>Step 2 of 3 — Enter your details</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="fullName" placeholder="Your name" className="pl-9" value={form.fullName} onChange={set("fullName")} />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="you@example.com" className="pl-9" value={form.email} onChange={set("email")} />
                </div>
            ...
            <p className="mt-4 text-center text-sm text-muted-foreground">
              <a href="#" onClick={(e) => { e.preventDefault(); navigate("/signup"); }} className="text-primary hover:underline">
